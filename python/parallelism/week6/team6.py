...
def copy_file(log, filename1, filename2, sender):
    # TODO create a pipe 
    
    # TODO create variable to count items sent over the pipe

    # TODO create processes 
    process1 = mp.Process(target=are_files_same, args=())
    ...
    log.stop_timer(f'Total time to transfer content = {sender.elaspedtime}: ')
