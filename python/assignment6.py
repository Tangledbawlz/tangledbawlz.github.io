...
class Bagger(mp.Process):
    ...
    def __init__(self, p2, p1, marbles):
        mp.Process.__init__(self)
        # TODO Add any arguments and variables here
        self.p1 = p1
        self.p2 = p2
...
class Wrapper(mp.Process):
    ...
    def __init__(self, p3, assemble, numbgift):
        mp.Process.__init__(self)
        # TODO Add any arguments and variables here
        self.p3 = p3
        self.assemble = assemble
        self.numbgift = numbgift

    def run(self, p3, assemble, numbgift):
        '''
        ...
        while there are gifts to process
            ...
            sleep the required amount
        '''
        if(p3.recv(assemble) == TRUE):
            numbgift +=1


def display_final_boxes(filename, log, numb):
...
def main():
    ...
    p1 = mp.Process(target=Marble_Creator, args=(parent_conn,)) 
    p2 = mp.Process(target=Bagger, args=(middle_conn,))
    p3 = mp.Process(target=Assembler, args=(child_conn,))
